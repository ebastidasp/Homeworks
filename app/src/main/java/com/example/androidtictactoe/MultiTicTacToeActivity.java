    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null){
            ...
            if(nombreSala.equals(username)){
                ...
                mPlayerImageView.setImageResource(R.drawable.equis);
            } else {
                mRole = TicTacToeGame.PLAYER2_PLAYER;
                playerText = getResources().getString(R.string.str_player_2) +": "+username;
                mPlayerImageView.setImageResource(R.drawable.circulo);
            }
        }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch(id) {
            ...
            case DIALOG_SALA_CERRADA:
                ...
                builder.setMessage("Sala Cerrada")
                        .setCancelable(false)
    ...
    private void startNewGame(){
        ...
        if (mPlayer1Start) {
            if(mRole == TicTacToeGame.PLAYER1_PLAYER){
                ...
                mInfoTextView.setText("Jugador 1 Inicia");
            }
            ...
            if(mRole == TicTacToeGame.PLAYER2_PLAYER){
                ...
                mInfoTextView.setText("Jugador 2 Inicia");
            }
        }
        ...
        if (!mGameOver && setMove(player, pos)) {
            ...
            if (winner != 0) {
                ...
                if(player != mRole){
                    ...
                    mInfoTextView.setText("Turno del Jugador 2");
                } else {
                    mInfoTextView.setText("Turno del Jugador 1");
                }
                ...
                if(snapshot.exists()) {
                    if (mRole == TicTacToeGame.PLAYER2_PLAYER && snapshot.getValue(String.class).equals("")) {
                        ...
                        try {
                            ...
                            Toast.makeText(MultiTicTacToeActivity.this, "Sala Cerrada", Toast.LENGTH_SHORT).show();
                            System.out.println(e.getStackTrace());
                            finish();
                        }
                    }
